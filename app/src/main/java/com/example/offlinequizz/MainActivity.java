...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LinearLayout administrator = findViewById(R.id.administratorLayout);
        ...
        final Button startBtn = findViewById(R.id.startQuizzBtn);
        ...
        administrator.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                selectedTopicName = "administrator";

                administrator.setBackgroundResource(R.drawable.round_back_white_stroke);
        ...
        php.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                administrator.setBackgroundResource(R.drawable.round_back_white10);
                html.setBackgroundResource(R.drawable.round_back_white10);
                android.setBackgroundResource(R.drawable.round_back_white10);
